...
class SanphamsTest < ApplicationSystemTestCase
  ...
  test "creating a Sanpham" do
    ...
    fill_in "Giaban", with: @sanpham.giaban
    fill_in "Loaisanpham", with: @sanpham.loaisanpham_id
    fill_in "Mota", with: @sanpham.mota
    fill_in "Tensanpham", with: @sanpham.tensanpham
    fill_in "Thuonghieu", with: @sanpham.thuonghieu_id
